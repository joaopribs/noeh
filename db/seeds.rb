...
criar_padrao_relacionamento('Ex-marido', 'Ex-esposa')
criar_padrao_relacionamento('Ex-namorado', 'Ex-namorada')
...
setar_relacionamento_oposto('Ex-marido', 'Ex-marido')
setar_relacionamento_oposto('Ex-namorado', 'Ex-namorado')
